...
<body class="min-h-screen bg-gradient-to-br from-rose-50 to-pink-50 font-sans antialiased">
    <div class="flex min-h-screen items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            <div class="mb-8 text-center">
                ...
                <h1 class="text-2xl font-semibold text-gray-800">Wedding Planner</h1>
                <p class="mt-1 text-sm text-gray-500">Rencanakan hari istimewa Anda</p>
            </div>
            @yield('content')
        </div>
    </div>
