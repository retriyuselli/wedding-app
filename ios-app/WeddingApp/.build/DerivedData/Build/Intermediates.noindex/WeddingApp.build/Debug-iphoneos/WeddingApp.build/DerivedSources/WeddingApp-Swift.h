...
#ifndef WEDDINGAPP_SWIFT_H
#define WEDDINGAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WeddingApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class NSData;
SWIFT_CLASS("_TtC10WeddingApp11AppDelegate")
...
SWIFT_CLASS("_TtC10WeddingApp18AppleSignInService")
...
@interface AppleSignInService (SWIFT_EXTENSION(WeddingApp)) <ASAuthorizationControllerPresentationContextProviding>
...
@interface AppleSignInService (SWIFT_EXTENSION(WeddingApp)) <ASAuthorizationControllerDelegate>
...
SWIFT_CLASS("_TtC10WeddingApp23PushNotificationManager")
...
@interface PushNotificationManager (SWIFT_EXTENSION(WeddingApp)) <UNUserNotificationCenterDelegate>
