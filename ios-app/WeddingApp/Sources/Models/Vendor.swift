...
struct VendorPromo: Identifiable {
    let id: Int
    let eyebrow: String
    let title: String
    ...
    static let samples: [VendorPromo] = [
        VendorPromo(
            id: 1,
            eyebrow: "Rekomendasi Untukmu",
            title: "Vendor pilihan dengan\nrating terbaik",
            buttonTitle: "Lihat Rekomendasi",
            gradient: [AppTheme.sage, AppTheme.sageDark],
        ...
        VendorPromo(
            ...
            title: "Paket wedding\nhemat hingga 20%",
            buttonTitle: "Lihat Promo",
            gradient: [AppTheme.gold, AppTheme.goldDark],
            imageName: nil
        ),
        VendorPromo(
            id: 3,
            eyebrow: "Trending",
            title: "Vendor terfavorit\nbulan ini",
            buttonTitle: "Jelajahi",
            gradient: [AppTheme.plum, AppTheme.sageDark],
            imageName: nil
        ),
        VendorPromo(
            id: 4,
            ...
            gradient: [AppTheme.peachDark, AppTheme.sageDark],
            imageName: nil
        ),
    ]
}
