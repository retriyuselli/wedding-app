...
struct PrivacyPolicyView: View {
    ...
    private var content: PrivacyPolicyLocaleContent {
        PrivacyPolicyContent.content(for: selectedLanguage)
    }
    ...
    private var contactCard: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(spacing: 10) {
                Link(destination: URL(string: "mailto:\(PrivacyPolicyContent.contactEmail)")!) {
