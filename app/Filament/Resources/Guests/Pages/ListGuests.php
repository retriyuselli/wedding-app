    ...
    protected function getHeaderActions(): array
    {
        return [
            Action::make('downloadTemplate')
                ...
                ->color('gray')
                ->action(fn (): BinaryFileResponse => app(GuestExcelService::class)->downloadTemplate()),
            Action::make('importExcel')
                ->label('Upload Excel')
                ->icon(Heroicon::OutlinedArrowUpTray)
                ->modalHeading('Import Daftar Tamu dari Excel')
                ...
                ->action(function (array $data): void {
                    ...
                    $result = app(GuestExcelService::class)->import($user, $absolutePath);
                    ...
                    $notification = Notification::make()
                        ->title('Import daftar tamu selesai')
                        ->body($body);
